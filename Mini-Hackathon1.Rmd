...
a. Choose a political issue and perform a sentiment analysis. 
...
Subsequently normalize the length of documents and compute a sort of overall sentiment score.
...
b. If you use another dictionary, would you get the same results? 
...
To understand the outcome of the correlation better, it can be useful to visualize the over time trends of sentiment on the economy reported in the Guardian based on both dictionaries. 
...
d. The method used in the tutorial is pretty crude. Even for dictionary methods, there are ways to improve results. Can you think of any problem in particular, and any ways to mend them? Are there problems which cannot be solved, or would be very hard to solve?
