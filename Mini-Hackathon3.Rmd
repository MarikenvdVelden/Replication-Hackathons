...
#### Challenge 2
Develop an infographic making a meaningful visualization of your data with `ggplot2`.
Try to make the plot as appealing as possible.
...
#### Challenge 3
What does your graph demonstrate? Write it up as if you would inform an Economist reader.

#### Challenge 4
What if you would write for a tabloid newspaper, would you assess the visual literacy of the readershipto change? If so, what would you adjust in the infographic?
