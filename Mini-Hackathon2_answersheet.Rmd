...
_[Inspect and interpret the 10 topics using `terms`, `docvars` and plot a `wordcloud` for each topic to ease interpretation._
_Next, visualize the topic model using `LDAvis`._
