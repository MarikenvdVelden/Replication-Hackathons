...
a. _Choose a political issue and perform a sentiment analysis._ 
...
b. _If you would use another dictionary, do you get the same results?_
...
c. _Reflect on the validity of the current analysis, both at the level of specific hits and at an aggregate level._
...
d. _The method used in the tutorial is pretty crude. Even for dictionary methods, there are ways to improve results. Can you think of any problem in particular, and any ways to mend them? Are there problems which cannot be solved, or would be very hard to solve?_
